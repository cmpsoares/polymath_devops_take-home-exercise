[This example has been copied from the HashiCorp/terraform-aws-nomad example](https://github.com/hashicorp/terraform-aws-nomad/tree/master/examples/nomad-consul-ami)
---
